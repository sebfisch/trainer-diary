...
der Beine regelmäßiger Teil der Trainings sein.

Trainer sollten __spielnahe Übungssituationen__ schaffen. Im Rahmen
von Small Footwork Übungen simulieren zum Beispiel schnelle
Hüftdrehungen bei gleichzeitigem Umsetzen der Füße Korrekturschritte,
wie sie bei Täuschungen des Gegners notwendig sind.
...
nach dem Schlag noch die Lauerstellung in die Ubung eingebaut werden.
...
Das Aufwärmen sollte grundsätzlich gleitet sein und Aspekte aus dem
...
wird beim zuwurf grundsätzlich am Kopf gefasst und soll nicht trudeln.
...
Aufschlag präzise zu simulieren. Seitliche Zuwürfe mit hoher Frequenz
vor und neben den Körper fördern Racket Speed. Insbesondere Würfe mit
hoher Frequenz stellen hohe koordinative anforderungen an den Trainer,
der gleichzeitig zum Werfen die Bälle im anderen Arm nachschieben
muss.
...
Bei Zuspiel werden Bälle mit der Hand, die den Schläger hält, aus
...
Bei Zuspiel von der Seite wird der Ball höher geworfen und dann neben
...
auf unerwartete Weise (zum Beispiel hinterm Rücken oder zeischen den
Beinen) geschlagen. Bei Täuschungen wird zusätzlich zwischen
Köprpertäuschungen und Schlägertäuschungen oder Mischformen
...
flach ins Hinterfeld zu spielen (also Swip und keinen Lob, der zu
lange in der Luft wäre).
...
bewegt. Der Wechsel von schneller Ausholbewegung kann durch
Fallenlassen und weiches Auffangen eines Balles in der Hand oder mit
dem Schläger vorbereitet werden.
...
etwas schneiden und zufassen, um die Richtung zu ändern. Die selbe
Finte kann auch nach dem Aufschlag oder bei der Abwehr eines Smashs
ausgeführt werden.

  * Töten antäuschen, dann stattdessen kurz cross spielen

  * mit Körpertäuschung Longline Lob mit der Rückhand antäuschen,
durch Schnitt am Ball vorbei cross spielen
