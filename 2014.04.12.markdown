...
Übungen wechseln dazu seitliche Trippelschritte mit Sidesteps ab:
  ...
  * Partner stehen sich in halben Feld gegenüber, einer versucht den anderen zu ticken, sobald dieser das Halbfeld zu einer Seite verlässt und versucht zu fliehen
...
Schlagarms wird nach hinten gedreht, der __Ellenbogen angehoben__ und der
Arm angewinkelt. Unterarm und Schläger bilden dabei mit der nicht-
Schlaghand ein __Dach__. Der Schläger wird mit einem Lockeren
Vorhandgriff gehalten. Gleichzeitig zur Armbewegung wird die __Hüfte__
und der Fuß der Schlaghand im rechten Winkel nach hinten gedreht. Der
hintere Fuß steht dabei etwa parallel zur Grundlinie.
...
vorne, der zugehörige Fuß wird nach vorne gezogen.
...
springen ein Köprperdrehung so ausgeführt, dass der hintere Fuß nach
...
variieren. Zum Beispiel könnten die folgenden Übungen (oder eine
Auswahl dieser) zehn Sekunden langsam, dann zehn Sekunden schnell
ausgeführt werden, wonach eine zehnsekündige Pause folgt und dann die
nächste Übung.
...
dem Malayensprung ausgeführt. Dabei springt der Spieler aus der
...
Malayensprung schrittweise zu üben.

  * Ball bei vorne stehendem Spieler holen und nach Malayensprung werfen
  * zugeworfenen Ball bei Schlagbewegung mit der Hand blocken
  * nach langem Aufschlag in die Rückhandecke Clear nach Malayensprung
  * nach dem Zurücklaufen in die Mitte mit einem Fuß die vordere Aufschlaglinie berühren
  * die übende spieler spielt Clears mit einem anderen und tauscht zwischen den Schlägen den Schläger, den ein anderer Spieler am Netz bereit hält
...
Chinasprung, der es erlaubt den Ball schneller zurückzuspielen. Dabei
werden die Beine beim Sprung nicht getauscht und der Körper nicht
gedreht. Wegen der fehlenden Körperrotation ist der Schlag weniger
kraftvoll beziehungsweise erfordert mehr Kraft aus dem Schlagarm.

Eventuell nach einem kleinen Schritt mit dem rechten Fuß nach hinten,
wird ein Sidestep nach hinten ausgeführt, mit rechts abgesprungen und
dann __beidbeinig__ und __breitbeinig__ gelandet. Der
__Körperschwerpunkt__ soll nach der Landung zwischen den Beinen (und
nicht darüber hinaus) liegen. Beim Schlag wird die Hüfte etwas
eingedreht, der Treffpunkt soll am höchsten Punkt des Sprunges sein.
die Nullstellung wird möglichst früh eingenommen (vom Schläger ziehen
...
Chinasprung zu üben.
  ...
  * vor dem Netz stehend wirft ein Spieler dem schlagenden ins Halbfeld auf die Vorhand zu, dieser spielt einen Smash die Linie entlang
...
Um eine trainingseinheit zu beenden bieten sich Spiele an, die dafür
Sorgen, dass das Training mit einem positiven Gefühl endet.
...
holt einen Ball von der eigenen Grundlinie uns spielt einen Aufschlag
(diagonal, egal von welcher Seite). Gewonnen hat die Partei, die keine
Bälle mehr hinter der Grundlinie hat.
...
Halbfeld in die eine Richtung, der Verlierer in die andere Richtung
...
Zum Beispiel:
  ...
  * Präzisionsschläge vorab mit zwei Punkten pro Schlag
...
Demostrationsfähigkeit statt. Die folgenden Schläger werden geprüft.
  ...
  * Vorhand Clear
  * Vorhand Drop
  * Vorhand Drop geschnitten (aus dem Hinterfeld)
  * Malayensprung mit Umsprung
  * Chinasprung
  * Rückhand Clear
  * Ball präzise auf eine Matte spielen
